...
$db['happitail']['hostname'] = 'happitail.dyndns.info';
$db['happitail']['username'] = 'shanghai';
$db['happitail']['password'] = 'change_me****************************';
$db['happitail']['database'] = 'test';
...
$db['happitail']['dbcollat'] = 'utf8_general_ci';
